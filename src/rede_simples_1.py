...
def bayesian_net(nodes):
  ...
  bnet.add_cpds(TabularCPD("Atenção seletiva", 2, [[0.25], 
                                                   [0.75]]), 
                ...
                TabularCPD("Atenção", 2, [[0.5] * (2 ** 5), 
                                          [0.5] * (2 ** 5)], evidence = ["Atenção seletiva", "Atenção sustentada", "Tolerância a tarefas tediosas", "Esquecimentos", "Atenção alternada"], evidence_card = [2] * 5),
                
                TabularCPD("Função executiva", 2, [[0.5] * (2 ** 5), 
                                                   [0.5] * (2 ** 5)], evidence = ["Memória de trabalho/operacional", "Impulsividade/Controle inibitório", "Flexibilidade cognitiva", "Autoregulação comportamental", "Tomada de decisões"], evidence_card = [2] * 5),
                
                TabularCPD("Vivência temporal", 2, [[0.5] * (2 ** 5), 
                                                    [0.5] * (2 ** 5)], evidence = ["Manutenção/estabelecimento de planejamento", "Organização", "Concentração", "Habilidade de delegar tarefas/estabelecer prioridades", "Habilidade de cumprir prazos"], evidence_card = [2] * 5),
                
                TabularCPD("TDAH", 2, [[0.1, 0.2, 0.2, 0.8, 0.2, 0.8, 0.8, 0.9,], 
                                       [0.9, 0.8, 0.8, 0.2, 0.8, 0.2, 0.2, 0.1]], evidence = ["Atenção", "Vivência temporal", "Função executiva"], evidence_card = [2] * 3))
  bnet.check_model()
  return bnet
